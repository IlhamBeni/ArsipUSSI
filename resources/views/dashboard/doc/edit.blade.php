...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Data Dokumen</h1>
</div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-body table-responsive p-0 col-lg-10">
                    <div class="col-lg-8">
                        <form method="post" action="/document/{{ $docs->id_dokumen }}" class="mb-5">
                            @csrf
                            @method('put')
                            <div class="col-lg-9">
                                    ...
                                    <tbody>
                                        <div class="mb-3">
                                            <tr>
                                                ...
                                                <td>
                                                <input type="nama_dokumen" class="form-control @error('nama_dokumen') is-invalid @enderror" id="nama_dokumen" name="nama_dokumen" required autofocus value="{{ old('nama_dokumen', $docs->nama_dokumen) }}">
                                                    @error('nama_dokumen')
